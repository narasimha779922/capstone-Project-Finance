...
the pasid to each employee to _read finace to each sector to ramndaom to each to working to lang _month to each of the gain to learn  to maintain each other to wotking ;